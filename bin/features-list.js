...
const features = [
  ...
  'Custom Interceptors',
  'Swagger Integration',
  'Helmet Security Option',
  'Cors Security Option',
  'Fake Tech Stack Header',
...
const options = [
  ...
  '',
  'Security Options:',
  '  - Helmet: Add Helmet module and its config to application',
  '  - Cors: Add Cors module and its config to application',
  '  - Fake Headers: Implement a security interceptor to fake the application tech stack',
  '',
